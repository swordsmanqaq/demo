package cn.henghuasoft.exception.handler;/**
 * @author shkstart
 * @create 2023-04-25 19:10
 */

import cn.henghuasoft.exception.CustomException;
...
public class GlobalExceptionHandler {
    ...
    // 对CustomException进行处理,相当于catch(CustomException e)
    /**
     * 自定义异常处理
     *
     * @param e
    ...
    public AjaxResult businessExceptionHandler(CustomException e) {
        e.printStackTrace();
