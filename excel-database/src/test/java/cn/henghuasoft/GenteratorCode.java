...
public class GenteratorCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        strategy.setInclude(new String[]{"t_physical_data"}); // 需要生成的表
        strategy.setSuperEntityClass("cn.henghuasoft.base.domain.BaseDomain");
        strategy.setSuperServiceClass("cn.henghuasoft.base.service.IBaseService");
        strategy.setSuperServiceImplClass("cn.henghuasoft.base.service.impl.BaseServiceImpl");
        strategy.setSuperMapperClass("cn.henghuasoft.base.mapper.BaseMapper");
